cask "grpc-nimbus" do
  ...
  on_arm do
    ...
    sha256 "9e9b3735cebebc8292e8aa6aa30e8b975291475103e4dd0d869d61573192bba2"  # arm64
  end

  on_intel do
    url "https://github.com/CosmicMunkey/grpc-nimbus/releases/download/v#{version}/grpc-nimbus-v#{version}-darwin-x86_64.zip",
        verified: "github.com/CosmicMunkey/grpc-nimbus/"
    sha256 "3944216159709cd5b8c3d5d535c3eeae092d02bf61cb4e258fb0b621a185c3fd"  # x86_64
  end
